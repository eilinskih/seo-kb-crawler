...
policy and deadline enforcement are reviewed together at the worker execution
boundary. The safe network gateway implementation now covers structural URL
validation, HTTP(S)-only requests, DNS/IP safety checks, manual redirect limits,
